O Site possui apenas 30 musicas, Eu coloquei poucas musicas pois o site estava ficando muito pesado. Caso queira adicionar mais musicas basta atualizar a lista de musicas JSON no codigo.
...
The site has a star bug, when you click on the star to favorite a song only the first card will have the gold star,
but the song will be saved and appear in the "FAVORITES" section anyway.